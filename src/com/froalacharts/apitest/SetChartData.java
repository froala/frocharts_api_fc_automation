...
public class SetChartData extends APITestBase 
{
	...
	private final static String apiName = "setChartData()"; 
	Object[][] data;
	...
	@Test(priority = 1)
	public void verifyAPIExistsInDataSheetSetChartData()
	{
	...
	@Test(priority = 2)
	public void verifyChartIsRenderedSetChartData()
	{
	...
	@Test(priority = 3)
	public void verifyAPISetChartData() throws IOException
	{
